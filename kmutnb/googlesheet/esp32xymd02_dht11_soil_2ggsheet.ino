...
//================New Blynk IoT=================//
#define BLYNK_TEMPLATE_ID ""            //Firmware configuration
#define BLYNK_DEVICE_NAME ""            //Firmware configuration
#define BLYNK_FIRMWARE_VERSION        "0.2.0"  //เปลี่ยน version ตามเงื่อนไข
...
void sendData2GGSheet() {
  ...
  HTTPClient http;
  String url = "https://script.google.com/macros/s/" + GAS_ID + "/exec?temp=" + temp + "&humi=" + humi + "&temp2=" + temp2 + "&humi2=" + humi2 + "&soil1=" + moisture_percentage;
  //Serial.print(url);
