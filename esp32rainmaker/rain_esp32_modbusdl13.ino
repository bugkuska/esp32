...
static TemperatureSensor temperature("อุณหภูมิ");
static TemperatureSensor humidity("ความชื้นสัมพัทธ์");
...
void Send_Sensor()
{
  ...
  Serial.println("Get DL13-Sensor Data");
  result = node1.readHoldingRegisters(0x040A, 2); // Read 2 registers starting at 1034)
  if (result == node1.ku8MBSuccess)
  {
    ...
    temperature.updateAndReportParam("Temperature", temp1);
    humidity.updateAndReportParam("Temperature", humi1);
  }
}
//========Read Sensor Data=========//
